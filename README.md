...
1. **RQ1:** What adaptation needs characterize robotic systems?
2. **RQ2:** To what extent can classical Behavior Tree features address these adaptation needs, and what limitations emerge?
3. **RQ3:** To what extent do approaches proposed to enhance BTs overcome those limitations, and what new limitations emerge?

The research design has three cumulative cycles: adaptation-need identification, classical-BT limitation analysis, and characterization of BT generation, extension, evolution, and refinement approaches.

## Repository contents

- `index.html`, `methodology.html`, `artifacts.html`, `studies.html`, and `validation.html`: the replication-package website.
- `artifacts/paper/`: the manuscript used to prepare this package.
...
- `artifacts/questionnaire/`: the complete questionnaire instrument.
...
Use the included `CITATION.cff` metadata when citing this replication package and cite the associated paper using its bibliographic record.

## Licensing

No separate reuse license is granted with this package. See `LICENSING.md`.
